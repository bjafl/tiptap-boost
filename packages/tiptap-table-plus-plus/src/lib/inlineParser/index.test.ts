...
eq('verticalAlign passthrough', get('vertical-align: middle', 'verticalAlign'), 'middle')
eq('kebab-case to camelCase', get('text-align: right', 'textAlign'), 'right')
eq('unsupported prop dropped', get('display: flex; height: 10px', 'height'), '10px')
...
eq('background-color atomic', get('background-color: red', 'backgroundColor'), 'red')
eq('background shorthand color', get('background: #abc', 'backgroundColor'), '#abc')
eq('background query shorthand', query('background-color: blue', 'background'), 'blue')
...
eq('padding 2-value: T/B and L/R', query('padding: 4px 8px', 'padding'), '4px 8px')
...
eq('padding atomic sides from shorthand', get('padding: 10px 20px', 'paddingTop'), '10px')
eq('padding atomic sides from shorthand', get('padding: 10px 20px', 'paddingRight'), '20px')
eq('padding atomic sides from shorthand', get('padding: 10px 20px', 'paddingBottom'), '10px')
eq('padding atomic sides from shorthand', get('padding: 10px 20px', 'paddingLeft'), '20px')
...
// Standard order
eq('border: width style color', get('border: 1px solid red', 'borderTopWidth'), '1px')
eq('border: width style color – style', get('border: 1px solid red', 'borderTopStyle'), 'solid')
eq('border: width style color – color', get('border: 1px solid red', 'borderTopColor'), 'red')

// Non-standard order: color first
eq('border color-first order', get('border: red solid 2px', 'borderTopColor'), 'red')
eq('border color-first: width still parsed', get('border: red solid 2px', 'borderTopWidth'), '2px')
eq(
...
eq('border style-only → no width', get('border: dashed', 'borderTopWidth'), null)
...
// Width keywords
eq('border width keyword thin', get('border: thin solid black', 'borderTopWidth'), 'thin')
eq('border width keyword thick', get('border: thick', 'borderTopWidth'), 'thick')

// Named colors (not mistaken for style or width)
eq('border named color: blue', get('border: 1px solid blue', 'borderTopColor'), 'blue')
eq('border named color: transparent', get('border: transparent', 'borderTopColor'), 'transparent')

// Hex color
eq('border hex color', get('border: 2px solid #ff0000', 'borderTopColor'), '#ff0000')
...
eq('border all sides: Right', get('border: 1px solid red', 'borderRightWidth'), '1px')
eq('border all sides: Bottom', get('border: 1px solid red', 'borderBottomStyle'), 'solid')
eq('border all sides: Left', get('border: 1px solid red', 'borderLeftColor'), 'red')

// Per-side shorthand
eq('borderTop shorthand', get('border-top: 2px dashed blue', 'borderTopWidth'), '2px')
eq('borderTop shorthand style', get('border-top: 2px dashed blue', 'borderTopStyle'), 'dashed')
eq('borderTop shorthand color', get('border-top: 2px dashed blue', 'borderTopColor'), 'blue')
eq(
...
eq('borderTopWidth atomic', get('border-top-width: 4px', 'borderTopWidth'), '4px')
eq('borderTopWidth does not affect Right', get('border-top-width: 4px', 'borderRightWidth'), null)
...
eq('later padding overrides earlier', get('padding: 5px; padding: 10px', 'paddingTop'), '10px')
...
eq('extra spaces in value', get('border:  1px  solid  red', 'borderTopWidth'), '1px')
eq(
...
eq('border: none → style is none', get('border: none', 'borderTopStyle'), 'none')
eq('border: none → no width', get('border: none', 'borderTopWidth'), null)
